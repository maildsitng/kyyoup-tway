...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/maildsitng/kyyoup-tway)  
...
* **务必替换所有的a796cf16-a109-4445-a160-d7b0cce82287为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：a796cf16-a109-4445-a160-d7b0cce82287
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/a796cf16-a109-4445-a160-d7b0cce82287-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "a796cf16-a109-4445-a160-d7b0cce82287"
    ],
    "websocket": {
        "enabled": true,
        "path": "/a796cf16-a109-4445-a160-d7b0cce82287-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/a796cf16-a109-4445-a160-d7b0cce82287-ss
```
</details>
